...
import org.opensearch.sql.expression.function.udf.math.AddFunction;
import org.opensearch.sql.expression.function.udf.math.DivideFunction;
import org.opensearch.sql.expression.function.udf.math.MultiplyFunction;
import org.opensearch.sql.expression.function.udf.math.SubtractFunction;
...
public class PPLBuiltinOperators extends ReflectiveSqlOperatorTable {
  ...
  public static final SqlOperator ADD = new AddFunction().toUDF("ADD");
  public static final SqlOperator SUBTRACT = new SubtractFunction().toUDF("SUBTRACT");
  public static final SqlOperator MULTIPLY_OP = new MultiplyFunction().toUDF("MULTIPLY");
