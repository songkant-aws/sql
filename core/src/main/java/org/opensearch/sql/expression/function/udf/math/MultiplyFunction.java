...
/**
 * Implementation for multiplication function with overflow checking for integral types. Uses
 * Math.multiplyExact to detect overflow instead of silently wrapping.
 */
public class MultiplyFunction extends ImplementorUDF {

  public MultiplyFunction() {
    super(new MultiplyImplementor(), NullPolicy.ANY);
  }
  ...
  public static class MultiplyImplementor implements NotNullImplementor {
    @Override
    public Expression implement(
        RexToLixTranslator translator, RexCall call, List<Expression> translatedOperands) {
      return Expressions.call(
          MultiplyImplementor.class,
          "multiply",
